...
function loadGA(){
	...
	r.setAttribute("src", "https://www.googletagmanager.com/gtag/js?id=G-RMGTRH283G"), r.setAttribute("type", "text/javascript"), r.setAttribute("crossOrigin", "anonymous"),  r.onload = function (){
        window.dataLayer = window.dataLayer || [];
        function gtag(){dataLayer.push(arguments);}
        gtag('js', new Date());
      
        gtag('config', 'G-RMGTRH283G');
